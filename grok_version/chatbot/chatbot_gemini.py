    ...
    try:
        ...
        **Instructions**:
        ...
        1. **Collecte stricte des informations**:
           ...
           - Étape 3: Matières (liste séparée par virgules, valider avec subjects_list, ex. 'Français,Mathématiques'). Stocker dans "user_subjects" et "subjects".
           - Étape 4: Notes (optionnelles, nombres entre 0 et 20, même longueur que matières ou moins). Stocker dans "grades".
